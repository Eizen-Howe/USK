...
<body class="bg-white">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="" role="button" data-toggle="dropdown">Data User</a>
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="/petugas">Petugas</a>
                                <a class="dropdown-item" href="/masyarakat">Masyarakat</a>
                            </div>
                        </li>
                        ...
                        @endauth
                        {{-- @auth('user')
                        <li class="nav-item"><a class="nav-link" href="/dashp">Landing Page</a></li>
                        ...
                        <li class="nav-item"><a class="nav-link" href="/history">History Pengaduan</a></li>
                        <li class="nav-item"><a class="nav-link" href="/edituser/{{ Auth::user()->nik }}">User Setting</a></li>                      
                        @endif
                        @endauth
                        @auth('web')
    ...
    <footer class="mt-auto" >
        <div class="navbar border border-top-dark">
            <p class="text-muted text-small mx-auto">Copyright ©2021 Pro<br>All Rights Reserved.</p>
        </div>
    </footer>
</body>
</html>
