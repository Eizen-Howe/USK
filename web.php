...
Route::middleware('auth', 'role:user')->group(function () {
    ...
    Route::delete('/deletepengaduan/{id}', 'PengaduanController@destroy');
    Route::get('/detailhistory/{id}', 'PengaduanController@showHistory');
    Route::get('/edituser/{nik}', 'MasyarakatController@edit');
    Route::put('/edituser/{nik}', 'MasyarakatController@update');
});
// End Rakyat Route